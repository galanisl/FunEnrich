#' Genes associated with Metabolic Disorders according to GWAS and OMIM
#'
...
#' \code{metabolic} is a sub-dataset of the above, representing genes associated with Metabolic Disorders.
#'
#' @docType data
#'
#' @format A character vector with Entrez IDs of genes associated with Metabolic Disorders.
#'
#' @keywords datasets
#'
...
#'
#' @examples
#' # Show the first three genes associated with metabolic disorders
#' metabolic[1:3]
#' 
"metabolic"
